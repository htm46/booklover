  ...
  <header>
    ...
    <div class="detail-container">
      <div class="detail-contents">
        <img src="/img/images/<?php echo $params['adv']['picture'] ?>">
        <h1><?php echo $params['adv']['title'] ?></h1>
        <h3>By <?php echo $params['adv']['author'] ?></h3>
        <p>
          レベル：<?php echo $params['adv']['level'] ?><br><br>
          <?php echo $params['adv']['description'] ?>
        </p>
